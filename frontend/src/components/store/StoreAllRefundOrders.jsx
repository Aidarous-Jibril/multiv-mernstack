...
const StoreAllRefundOrders = () => {
  ...
  useEffect(() => {
    ...
    const refundedOrders = orders && orders.filter((item) => item.status === "Processing refund"  || item.status === "Refund Success");
...
export default StoreAllRefundOrders;
