...
//   ChevronDownIcon,
//   ChevronUpIcon,
//   SearchIcon, UserIcon, ShoppingCartIcon,
...
// const HeaderBottom = ({ categories, active }) => {
//   const ref = useRef();
...
//                     to={item.url}
//                     className={`${
//                       active === index + 1 ? "text-red-500 border-red-500" : "text-white"
...
//         animate={{ x: sidebar ? 0 : -500, opacity: sidebar ? 1 : 0 }}
...
//       <ShoppingCartIcon onClick={() => setSidebar(!sidebar)} className="h-6 w-6 text-white cursor-pointer" />
//     </div>
//         </div>
//       </motion.div>
//     </>
